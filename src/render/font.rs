...
impl BitmapFont {
    ...
    pub fn draw_char_with_shadow(&self, c: char, x: f32, y: f32, fg_color: Color, shadow_color: Color) {
        // Draw shadow first
    ...
    pub fn draw_char_with_shadow_scaled(&self, c: char, x: f32, y: f32, scale: f32, fg_color: Color, shadow_color: Color) {
